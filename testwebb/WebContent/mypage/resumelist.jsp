			...
			<section class="content">
				...
				<div class="contWrap ResumeMngCont">
					<div class="innerHd">
						<ul>
							<li class="hdTab"><a
								href="http://127.0.0.1:8080/testwebb/rslist.tiles">이력서 관리</a></li>
							<li class="on"><a
								href="http://127.0.0.1:8080/testwebb/pflist.tiles">첨부파일 관리</a></li>
						</ul>
					</div>
			...
			<section class="secLnb">
				...
				<div class="lnbGroup">
					...
					<ul>
						...
						<li><a href="http://127.0.0.1:8080/testwebb/rslist.tiles">이력서
								관리</a></li>
					</ul>
				</div>
				<div class="lnbGroup">
