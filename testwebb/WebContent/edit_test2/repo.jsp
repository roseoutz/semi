...
<script type="text/javascript" src="./edit_test2/resources/EchoScriptV2.js"></script>
<!-- 키워드 스크립트 끝 -->


<!-- DataStory Javascript Tracking  -->
<script type="text/javascript" src="./edit_test2/resources/dslog.js" id="dslog_tag"></script>
<script type="text/javascript">
    ...
    //-->
					...
					<link rel="stylesheet" type="text/css" href="./edit_test2/resources/common.css">
				
			<link rel="stylesheet" type="text/css" href="./edit_test2/resources/footer_sub.css">
	
	<link rel="stylesheet" type="text/css" href="./edit_test2/resources/gnb.css">
	<link rel="stylesheet" type="text/css" href="./edit_test2/resources/gnb_sub.css">

	
	<link rel="stylesheet" type="text/css" href="./edit_test2/resources/mbr_common.css">
	<link rel="stylesheet" type="text/css" href="./edit_test2/resources/mbr_tpl.css">
	
	<link rel="stylesheet" type="text/css" href="./edit_test2/resources/mbr_style.css">
	
<script type="text/javascript" src="./edit_test2/resources/jquery-1.7.1.min.js"></script>
<script type="text/javascript" src="./edit_test2/resources/Common_Regist.js"></script>
<script type="text/javascript" src="./edit_test2/resources/Resume_Open_Check.js"></script>
<script type="text/javascript" src="./edit_test2/resources/underscore.js"></script>
<script type="text/javascript" src="./edit_test2/resources/naverLogin_implicit-1.0.2.js" charset="utf-8"></script>
<script src="./edit_test2/resources/client_platform.js" gapi_processed="true"></script>
<script type="text/javascript" src="./edit_test2/resources/kakao.min.js"></script>
<script type="text/javascript" src="./edit_test2/resources/SNS.js"></script>
<script type="text/javascript">
<!--
