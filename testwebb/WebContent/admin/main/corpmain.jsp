		...
		<div class="pointWrap">
			<div class="pointSide">
				...
				<div class="loginWrap">
					...
					<ul class="memberType clear">
						<li style="width: 130px;"><input type="text" name="UserId"
							placeholder="Insert ID" style="height: 22px;"> <br>
							<input type="text" name="UserPw" placeholder="Insert PW"
							style="height: 22px;"></li>
						<li style="width: 90px;"><input type="button"
							class="btn btn1" value="로그인"></li>
					</ul>
					<div class="mbrLinks clear">
						<span class="mbr dotum"> <a
							href="http://127.0.0.1:8080/testwebb/joingen.tiles"
				...
				<div class="quickMenuWrap">
					<ul class="clear devQuickStater" style="display: block;">
						<li class="item_1"><a
							href="http://www.jobkorea.co.kr/starter/"
							class="mainBtnB mainBtnMajor devHref devClick"
							data-click-value="61"><span>1000대기업</span></a></li>
						<li class="item_2"><a
							href="http://www.jobkorea.co.kr/starter/calendar/"
							class="mainBtnB mainBtnCalendar devHref devClick"
							data-click-value="62"><span>공채달력<span
									class="mainIcn mainIcnUpdate" title="update"><span
										class="blind">update</span></span></span></a></li>
						<li class="item_3"><a
							href="http://www.jobkorea.co.kr/top100/?Main_Career_Type=1&amp;Search_Type=1"
							class="mainBtnB mainBtnTop100 devHref devClick"
							data-click-value="93"><span>TOP100</span><span
								class="mainIcn mainIcnNew" title="NEW"><span
									class="blind">NEW</span></span></a></li>
						<li class="item_4"><a
							href="http://www.jobkorea.co.kr/starter/?schWork=2"
							class="mainBtnB mainBtnIntern devHref devClick"
							data-click-value="64"><span>인턴채용</span></a></li>
						<li class="item_5"><a
							href="http://www.jobkorea.co.kr/starter/passassay/"
							class="mainBtnB mainBtnPass devHref devClick"
							data-click-value="65"><span>합격자소서<span
									class="mainIcn mainIcnUpdate" title="update"><span
										class="blind">update</span></span></span></a></li>
						<li class="item_6"><a
							href="http://www.jobkorea.co.kr/starter/review/"
							class="mainBtnB mainBtnReview devHref devClick"
							data-click-value="66"><span>취업후기<span
									class="mainIcn mainIcnUpdate" title="update"><span
										class="blind">update</span></span></span></a></li>
						<li class="item_7"><a
							href="http://www.jobkorea.co.kr/starter/spec/"
							class="mainBtnB mainBtnSpec devHref devClick"
							data-click-value="67"><span>합격스펙</span><span
								class="mainIcn mainIcnNew" title="NEW"><span
									class="blind">NEW</span></span></a></li>
						<li class="item_8"><a
							href="http://www.jobkorea.co.kr/starter/interview"
							class="mainBtnB mainBtnIterview devHref devClick"
							data-click-value="68"><span>직무인터뷰<span
									class="mainIcn mainIcnUpdate" title="update"><span
										class="blind">update</span></span></span></a></li>
						<li class="item_9"><a
							href="http://www.jobkorea.co.kr/starter/jobfair/"
							class="mainBtnB mainBtnJobfair devHref devClick"
							data-click-value="69"><span>채용설명회</span></a></li>
					</ul>
				</div>
			</div>
			...
			<div class="pointMain">
				<div class="grand_banner_wrap" style="width: 810px;">
					<h3 class="header">지원자 현황</h3>
					<div class="company">
					<ul class="list list_banner_5xn list_plus"
						style="width: 810px; float:left;">
						<li class="itemTopBg"
							style="width: 800px; height: 70px; float: left;">
								<span class="name"> <a
									href="http://www.jobkorea.co.kr/Recruit/Booth_GI_Read/27073301?Oem_Code=C1"
									onclick="Job_DB_window(this.href,1000,500);SpaceClick(27073301,4);adobeDtmOptClick('JH', 'GrandPlus');return false;"
									target="_blank"> <span class="logo"
										style="width: 50px; height: 60px;"> <img
											src="//img12.jobkorea.kr/Images/Logo/106/m/i/migung0365_106.gif?20181221110506"
											width="50px" height="60px" alt=""
											onerror="this.src='//img.jobkorea.co.kr/Images/Logo/106/l/o/logo_none_106.gif';">
									</span>
								</a>
								</span>
							</div>
							...
							<div class="description">
								<a
									href="http://www.jobkorea.co.kr/Recruit/Booth_GI_Read/27073301?Oem_Code=C1"
									onclick="Job_DB_window(this.href,1000,500);SpaceClick(27073301,4);adobeDtmOptClick('JH', 'GrandPlus');return false;"
									target="_blank"> 웹기획 온라인 마케팅/고객상담(CS) 채용 </a>
							</div>
							</li>
					</ul>
					</div>
