    ...
    <div class="loginWrap">
        ...
        <ul class="memberType clear">
            <li style="width:130px;">
         		<input type="text" name="admin_id"  placeholder="Insert ID" style="
         		height:22px;">
			<br>
				<input type="password" name="admin_pass"  placeholder="Insert PW" style="
         		height:22px;">
            </li>
            <li style="width:90px;">
            	<button type="submit" class="btn btn1" value="로그인">로그인</button>
            </li>
        </ul>
        </form>
