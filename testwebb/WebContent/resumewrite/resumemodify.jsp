...
<body class="resume resume-write" style="">
	<div class="resumePage">
		...
		<form action="resumeModify.action" method="post" id="frm1" enctype = "multipart/form-data">
				...
				<div class="resumeContainer">
					<div class="resumeTitle">
						<input id="UserResume_M_Resume_Title" maxlength="100"
							name="resume_subject" value="<s:property value = "apply.resume_subject"/>"
						...
						<div class="form formProfile">
							<div class="row">
								...
								<div class="input is-label input-profile-hp is-value">
									...
									<input
										...
										maxlength="30" value = "<s:property value = "apply.resume_birth"/>">
								...
								<div class="input is-label input-profile-hp is-value" style="width:100px">
										...
										<select name="resume_sex">
											<option value = "<s:property value = "apply.resume_sex"/>"><s:property value = "apply.resume_sex"/></option>
							...
							<div class="row">
								...
								<div class="input is-label input-profile-hp is-value"
									...
									<input type="text" name="resume_addr" id="sample4_roadAddress" value="<s:property value = "apply.resume_addr"/>" maxlength="30"> 
								...
								<div class="container container1" data-cid="c536">
									<div class="row">
										...
										<select name="edu_school_type">
											<option value = "<s:property value = "apply.edu_school_type"/>"><s:property value = "apply.edu_school_type"/></option>
										...
										<label for="UnivSchool_Entc_YM_c536">학교명(OO대학교)</label> 
										 <input type="text" value = "<s:property value = "apply.edu_school"/>" name="edu_school" id="UnivSchool_Schl_Name_c536" placeholder="OO대학교" maxlength="50">
										</div>

										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="UnivSchool_Entc_YM_c536">입학년월(2018.01)</label> 
											<input
												type="text" name="edu_enter_date" value = "<s:property value = "apply.edu_enter_date"/>"
												id="UnivSchool_Entc_YM_c536" placeholder="입학년월">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="UnivSchool_Grad_YM_c536">졸업년월(2018.01)</label> <input
												type="text" name="edu_graduate_date" value = "<s:property value = "apply.edu_graduate_date"/>"
									...
									<div class="row">
										...
										<div class="input is-label input-profile-hp is-value" style="width:400px">
												<label for="univmajor_0_0">전공명</label> <input type="text"
													id="univmajor_0_0" name="edu_major" value = "<s:property value = "apply.edu_major"/>"
													maxlength="50">
											</div>
										...
										<div class="input is-label input-profile-hp is-value" style="width:100px">
											<label for="UnivSchool_Grade_c536">학점(0.0/0.0)</label> <input
												...
												id="UnivSchool_Grade_c536" value="<s:property value = "apply.edu_grade"/>" maxlength="7"
										...
										<select name="edu_graduate_status">
											<option value = "<s:property value = "apply.edu_graduate_status"/>"><s:property value = "apply.edu_graduate_status"/></option>
						...
						<div class="form formCareer">
							<div id="career_containers">
								<div class="container container1">
									<div class="row">
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="Career_C_Name_c6">회사명</label> <input type="text" name="career_cname" value = "<s:property value = "apply.career_cname"/>"
												id="Career_C_Name_c6" maxlength="50">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											> <label for="Career_C_Part_c6">부서명</label>
											<div class="validation hidden" aria-hidden="true"></div>
											<input type="text" name="career_dept" value = "<s:property value = "apply.career_dept"/>"
												id="Career_C_Part_c6" value="" maxlength="25">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="Career_CSYM_c6">입사년월</label> <input type="text"
												name="career_enter_date" id="Career_CSYM_c6" value="<s:property value = "apply.career_enter_date"/>"
												data-format-type="month" placeholder="2016.03">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="Career_CEYM_c6">퇴사년월</label> <input type="text"
												name="career_leave_date" id="Career_CEYM_c6" value="<s:property value = "apply.career_leave_date"/>"
												data-format-type="month" class="devCareerCEYM">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="Career_CEYM_c6">직급/직책</label> <input type="text"
												name="career_position" id="Career_CEYM_c6" value="<s:property value = "apply.career_position"/>"
												data-format-type="month" class="devCareerCEYM">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="Career_CEYM_c6">직무</label> <input type="text"
												name="career_job" id="Career_CEYM_c6" value="<s:property value = "apply.career_job"/>"
												data-format-type="month" class="devCareerCEYM">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="Career_CEYM_c6">연봉</label> <input type="text"
												name="career_pay" id="Career_CEYM_c6" value="<s:property value = "apply.career_pay"/>"
												data-format-type="month" class="devCareerCEYM">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="Career_CEYM_c6">담당업무</label> <input type="text"
												name="career_explain" id="Career_CEYM_c6" value="<s:property value = "apply.career_explain"/>"
												data-format-type="month" class="devCareerCEYM">
										</div>
									</div>
								</div>
									...
									<div class="row">
										<div class="input is-label input-profile-hp is-value" style="width:400px">
											<label for="License_Search_c12">수상 / 자격증명</label> <input
												type="text" value = "<s:property value = "apply.award_name"/>" id="License_Search_c12" maxlength="50" name="award_name">
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:200px">
											<label for="License_Lc_Pub_c12">발행처</label> <input
												type="text" name="award_publisher"
												id="License_Lc_Pub_c12" value="<s:property value = "apply.award_publisher"/>"
												maxlength="50">
											<div class="validation hidden" aria-hidden="true"></div>
										</div>
										<div class="input is-label input-profile-hp is-value" style="width:100px">
											<label for="License_Lc_YYMM_c12">취득월</label> <input
												...
												id="License_Lc_YYMM_c12" value="<s:property value = "apply.award_date"/>" data-format-type="month"
												>
											<div class="validation hidden" aria-hidden="true"></div>
										</div>
									</div>
					...
					<div class="formWrap formWrapPortfolio" id="formPortfolio" style="">
						...
						<div class="form formPortfolio">
							<div class="fileBox">
								...
								<input type="text" name="port_url" value = "<s:property value = "apply.port_url"/>" style="height:30px; width:300px;">
							</div>
							<script>
						...
						<div class="fixedMenu media-size-small" id="FixedMenuView">
							...
							<div class="notifacation">수정 되었습니다.</div>
						</div>
					</div>
				</div>
		</form>
